...
Step1: Import the necessary libraries of python.

Step2: In the end_to_end function, first calculate the similarity between the inputs and the peaks. Then, to find w used the equation Aw= Y in matrix form.

Each row of A (shape: (4, 2)) consists of

Step3: Index[0]: similarity of point with peak1
...
Step 4: This part is the same as using a neural network architecture of 2-2-1,
...
Step 5: To find the weights for the edges to the 1-output unit. Weights associated would be:
...
![image](https://github.com/sanjay5656/Experiment-5-Implementation-of-XOR-using-RBF/assets/115128955/15b9444b-f5d9-4e8d-96fe-0c354d84ded0)

![image](https://github.com/sanjay5656/Experiment-5-Implementation-of-XOR-using-RBF/assets/115128955/f0a3db32-ed9a-45d2-927e-996a19af2f1e)

## RESULT:

Implementation-of-XOR-using-RBF successfully completed.
